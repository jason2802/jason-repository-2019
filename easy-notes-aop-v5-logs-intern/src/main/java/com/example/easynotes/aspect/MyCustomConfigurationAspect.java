...
public class MyCustomConfigurationAspect {
	...
	private static final Logger LOGGER = LogManager.getLogger( MyCustomConfigurationAspect.class );
	...
	@Before("@annotation(com.example.easynotes.aspect.UserAccess)")	
	public void before(JoinPoint joinPoint) throws Throwable {
		LOGGER.debug( " +++++++++ get Inside before getUserAccess ------------ ");
		System.out.println(" +++++++++ metodo invocato : " + joinPoint.getSignature().getName() );
